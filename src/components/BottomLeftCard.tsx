...
export default function BottomLeftCard() {
  return (
    ...
    >
      ...
      >
        <span className="bg-[rgba(30,50,90,0.08)] rounded-full p-1.5 flex items-center justify-center">
          <ArrowUpRight className="w-4 h-4 text-[rgba(30,50,90,0.9)]" />
        </span>
        <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)]">Try a Sample</span>
      </motion.button>
    </motion.div>
  );
}
