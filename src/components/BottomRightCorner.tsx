...
export default function BottomRightCorner() {
  return (
    ...
    >
      ...
      <div className="absolute -top-5 right-0 w-5 h-5 bg-[#f0f0f0]"
        style={{
      ...
      <div className="absolute bottom-0 -left-5 w-5 h-5 bg-[#f0f0f0]"
        style={{
      ...
      <div className="bg-[rgba(30,50,90,0.05)] w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center border border-[rgba(30,50,90,0.1)]">
        <ArrowUpRight className="w-6 h-6 md:w-7 md:h-7 text-[rgba(30,50,90,0.8)]" />
      </div>

      <div className="flex flex-col">
        <span className="text-[18px] md:text-[24px] font-normal text-[rgba(30,50,90,0.95)]">
          Documentation
        </span>
        <span className="flex items-center gap-1 text-[13px] md:text-[16px] font-normal text-[rgba(30,50,90,0.6)]">
          Library
